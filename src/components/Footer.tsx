        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://mx.pinterest.com/esmeraldaconstructioninc/_created" target="_blank" rel="noopener noreferrer" className="bg-olive/20 p-3 rounded-full hover:bg-energy transition-colors">
                {/* Pinterest SVG */}
